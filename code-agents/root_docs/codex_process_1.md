...
# Codex: процесс работы — модель, субагенты, skills, MCP и автономность

## Оглавление
- [Короткий вывод](#короткий-вывод)
- [1. Базовая модель управления Codex](#1-базовая-модель-управления-codex)
- [2. Что такое субагенты](#2-что-такое-субагенты)
- [3. Built-in subagents и custom agents](#3-built-in-subagents-и-custom-agents)
- [4. Что такое skills](#4-что-такое-skills)
- [5. Что такое MCP](#5-что-такое-mcp)
- [6. Что такое `AGENTS.md`](#6-что-такое-agentsmd)
- [7. Что такое `config.toml`](#7-что-такое-configtoml)
- [8. Approval policy и sandbox](#8-approval-policy-и-sandbox)
- [9. Rules](#9-rules)
- [10. Web search и веб-доступ](#10-web-search-и-веб-доступ)
- [11. Может ли Codex открывать страницы, нажимать кнопки и заполнять формы](#11-может-ли-codex-открывать-страницы-нажимать-кнопки-и-заполнять-формы)
- [12. Что умею именно я в текущей логике управления](#12-что-умею-именно-я-в-текущей-логике-управления)
- [13. Практическая схема управления Codex](#13-практическая-схема-управления-codex)
- [14. Рекомендуемая стратегия настройки](#14-рекомендуемая-стратегия-настройки)
- [15. Automations](#15-automations)
- [16. Что тебе полезно сделать practically](#16-что-тебе-полезно-сделать-practically)
- [17. Самые полезные официальные ссылки](#17-самые-полезные-официальные-ссылки)
