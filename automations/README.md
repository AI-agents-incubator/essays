...
- Если вам нужно автоматизировать публикацию видео на YouTube с AI-генерацией метаданных, описаний, таймкодов и обложек, откройте [video-youtube.md](/automations/video-youtube.md).
- Если ваша задача — быстро увидеть общий roadmap миграции большого Vimeo-архива в YouTube и далее в knowledge base, начните с [vimeo-migration.md](/automations/vimeo-migration.md).
- Если вам нужен именно инженерный transport pipeline Vimeo → YouTube, с `yt-dlp`, batching и Python-примерами, используйте [vimeo-youtube.md](/automations/vimeo-youtube.md).
- Если ваша цель — превратить YouTube-архив в RAG-ready knowledge base, а не просто перелить видео между платформами, откройте [RAGprepare.md](/automations/RAGprepare.md).
- Если у вас уже есть большой массив Markdown-файлов и вы хотите построить над ним semantic layer, controlled vocabulary и индексный слой, идите в [semantic_index.md](/automations/semantic_index.md).
- Если вы хотите собирать не архив и не индекс, а фабрику автоматической генерации учебных видеокурсов, начните с [Video-Course-Generator.md](/automations/Video-Course-Generator.md).

## Что здесь лежит

- [video-youtube.md](/automations/video-youtube.md)  
...
- [vimeo-migration.md](/automations/vimeo-migration.md)  
...
- [vimeo-youtube.md](/automations/vimeo-youtube.md)  
...
- [RAGprepare.md](/automations/RAGprepare.md)  
...
- [semantic_index.md](/automations/semantic_index.md)  
...
- [Video-Course-Generator.md](/automations/Video-Course-Generator.md)
...
1. Начни с [vimeo-migration.md](/automations/vimeo-migration.md), чтобы увидеть общую дорожную карту.
2. Затем открой [vimeo-youtube.md](/automations/vimeo-youtube.md), если нужен детальный транспортный pipeline Vimeo → YouTube.
3. После этого читай [video-youtube.md](/automations/video-youtube.md), если нужен уже полноценный publish-пайплайн для YouTube.
4. Открой [RAGprepare.md](/automations/RAGprepare.md), если задача состоит в превращении видеоархива в RAG-ready базу знаний.
5. Затем читай [semantic_index.md](/automations/semantic_index.md), если хочешь построить более общий semantic layer над большим документным архивом.
6. Отдельно переходи к [Video-Course-Generator.md](/automations/Video-Course-Generator.md), если тебя интересует уже фабрика генерации учебных видео, а не архив и не миграция.
