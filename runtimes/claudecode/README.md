...
Эта директория предназначена для независимой реализации инфраструктуры агентной организации через `Claude Code`.

## Подкаталоги

- [workspace/README.md](./workspace/README.md) — рабочее пространство, где должна появиться реализация.
- [runs/README.md](./runs/README.md) — логи и материалы отдельных прогонов.
- [evaluation/README.md](./evaluation/README.md) — локальная оценка Claude Code-реализации.

Нормативный runtime-addendum: [agent_org_tz_claudecode.md](../../agent_org_tz_claudecode.md)
...
## Следующий benchmark после GT-002
...
## Следующий benchmark после GT-004

- [runs/RUN-005_GT-005_launch_brief.md](./runs/RUN-005_GT-005_launch_brief.md)
- [evaluation/RUN-005_GT-005_evaluation_template.md](./evaluation/RUN-005_GT-005_evaluation_template.md)

## Следующий benchmark после GT-005

- [runs/RUN-006_GT-006_launch_brief.md](./runs/RUN-006_GT-006_launch_brief.md)
- [evaluation/RUN-006_GT-006_evaluation_template.md](./evaluation/RUN-006_GT-006_evaluation_template.md)

## Следующий benchmark после GT-006

- [runs/RUN-007_GT-007_launch_brief.md](./runs/RUN-007_GT-007_launch_brief.md)
- [evaluation/RUN-007_GT-007_evaluation_template.md](./evaluation/RUN-007_GT-007_evaluation_template.md)
