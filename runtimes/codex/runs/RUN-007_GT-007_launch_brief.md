# RUN-007: Codex Launch Brief for GT-007
...
Выполнить `GT-007` для `Codex` внутри `runtimes/codex/` так, чтобы failed runtime до окончательного closeout сам оставил publishable failure package, пригодный для comparison и learning.
...
В рамках `RUN-007 / GT-007` `Codex` должен:
