...
Связанная краткая версия: [`codex_managment_readme.md`](./codex_managment_readme.md).
...
По архитектурной логике это тот же класс автономности, который для `Claude Code` подробно разобран в [agent_os_autonomy.md](./agent_os_autonomy.md):
